...
| Campaign 6 (2026-09-14 16:16 UTC chain start, 600 s on the merged revision-8 tree `31ca10c`; wall 13,025 s of which ~3 h post-run) | 7,043 (last tick) | corpus 416 | 29,223 | 153 passed, 2 failed (SP-24, SP-14) | both the revision-8 inventory-burn stream's settlement inside the call read as the call's own effect: SP-24 expected the compound's burn alone while its checkpoint settled an overdue 117-AMPS queue; SP-14 divided the pro-rata slice by the pre-settlement supply. Corrected in the fifth remediation wave (settled term added; slice on the settled supply). The campaign-5 SP-33 correction and every earlier correction held |
